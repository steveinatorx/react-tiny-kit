...
/***/ function(module, exports, __webpack_require__) {
	...
	_reactDom2.default.render(_react2.default.createElement(
	  ...
	  { store: store },
	  _react2.default.createElement(_components.SearchUXContainer, null)
...
/***/ function(module, exports, __webpack_require__) {
	...
	function reducer() {
	  var activeFields = arguments.length <= 0 || arguments[0] === undefined ? init : arguments[0];
	  var action = arguments[1];

	  switch (action.type) {
	    case 'SET_ACTIVE_FIELD':
	      return activeFields.map(function (f) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.SearchListNav = SearchListNav;
	...
	function SearchListNav(props) {
	    var searchFields = props.searchFields;
	    var setActiveField = props.setActiveField;

	    var clickField = function clickField(id) {
	        return function (event) {
	            return setActiveField(id);
	        };
	    };
	        ...
	        _react2.default.createElement(
	            ...
	            _react2.default.createElement(
	                ...
	                searchFields.map(function (f) {
	                    return _react2.default.createElement("li", { key: f.get('id'),
	                ...
	                _react2.default.createElement(
	                    ...
	                    _react2.default.createElement(
	                        "button",
	                        { className: "btn btn-success navbar-btn", type: "button" },
	                        "Current Results ",
	                        _react2.default.createElement(
	                            "span",
	                            { className: "badge" },
